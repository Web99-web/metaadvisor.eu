...
# Minimalni “editorial” filter (proširen za više kripto tema)
...
# ⚠️ Prazno: ne blokiramo doge/pepe itd. kako bi prošlo više kripto vijesti
BLOCK_TOPICS   = set()

# Mora sadržavati barem jedan od ovih pojmova (prošireno tvojim tokenima)
REQUIRE_ANY    = {
    "bitcoin","btc","ethereum","eth","ai","web3","crypto",
    # dodano:
    "solana","sol","pepe","doge","dogecoin","ada","cardano","trump",
    "tao","tia","avax","bnb","link","cro","ena","sui","sei","jto","inj","bgb","hype",
}
...
SOURCES = [
    ...
    {"name": "TechCrunch",         "rss": "https://techcrunch.com/feed/",                     "limit": 1},

    # — više kripta —
    {"name": "TechCrunch Crypto",  "rss": "https://techcrunch.com/category/crypto/feed/",     "limit": 2},
    {"name": "CoinDesk",           "rss": "https://www.coindesk.com/arc/outboundfeeds/rss/",  "limit": 4},
    {"name": "Cointelegraph",      "rss": "https://cointelegraph.com/rss",                    "limit": 4},
    {"name": "Decrypt",            "rss": "https://decrypt.co/feed",                          "limit": 3},
    {"name": "CryptoSlate",        "rss": "https://cryptoslate.com/feed/",                    "limit": 2},
]
...
def write_inbox(dt, payload):
    ...
    front = [
        ...
        f'category: "{payload["category"]}"',  # ostaje dinamički (crypto/ai/news)
