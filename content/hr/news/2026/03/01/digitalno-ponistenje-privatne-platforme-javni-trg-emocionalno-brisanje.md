---
title: "Digitalno poništenje: kada privatne platforme postanu javni trg i emocionalno izbrišu čovjeka"
slug: "digitalno-ponistenje-privatne-platforme-javni-trg-emocionalno-brisanje"
...
image_alt: "Emocionalno potreseni mladi ljudi simbolično prikazuju posljedice digitalnog brisanja s društvenih mreža"
image_credit: "Metaadvisor.eu"
tags: ["digitalni identitet", "ai moderacija", "digital services act", "društvene mreže", "algoritmi", "cenzura", "online zajednice", "psihološke posljedice", "sloboda govora", "digitalni javni trg"]
summary: "U posljednje vrijeme sve češće se u digitalnim zajednicama govori o dugogodišnjim korisnicima koji su iznenada nestali zbog AI moderacije. Što znači kada privatne platforme postanu javni trg – i kolika je emocionalna cijena digitalnog poništenja?"
---
...
# Digitalno poništenje: kada privatne platforme postanu javni trg i emocionalno izbrišu čovjeka
...
Digitalni identitet može biti profesionalni kapital, emocionalna vrijednost i društvena pripadnost.
...
To stvara osjećaj da sustav kažnjava angažman.
...
Da, društvene mreže su privatne tvrtke. Imaju pravo definirati pravila korištenja.

No kada platforma postane glavna infrastruktura javnog diskursa – mjesto gdje se odvija politička rasprava, financijska analiza i društveni aktivizam – ona poprima javnu funkciju.

Kada privatni prostor postane javni trg, postavlja se pitanje odgovornosti.

Ako algoritamska odluka može izazvati fizičku i emocionalnu destabilizaciju stvarne osobe, onda to više nije samo tehničko pitanje. To je društveno pitanje.

## Digital Services Act i pravna dimenzija

Europska unija kroz Digital Services Act pokušava povećati transparentnost i uvesti obvezu obrazloženja odluka o uklanjanju sadržaja. Platforme bi trebale omogućiti žalbene mehanizme i proporcionalnost mjera.

To je priznanje da digitalni identitet ima stvarnu vrijednost i da odluke o suspenziji ne mogu biti potpuno netransparentne.

Jer kada je digitalni prostor postao infrastrukturni dio društva, isključenje iz tog prostora ima posljedice koje nadilaze tehničke uvjete korištenja.

## Zaključak: između algoritma i čovjeka

Ovdje se ne radi o ukidanju moderacije. Govor mržnje i prijevare moraju imati posljedice.

Ali kada algoritamska odluka može emocionalno destabilizirati stvarnu osobu i istodobno šokirati cijelu zajednicu, tada više ne govorimo samo o tehnologiji. Govorimo o ljudima.

U post-Covid svijetu digitalni javni trg postao je stvaran prostor života. Brisanje profila može značiti društvenu stigmatizaciju i gubitak pripadnosti.

Ako su platforme postale javni trg, onda digitalna pravila moraju imati i digitalnu odgovornost.

---

## Naš osvrt (Metaadvisor)

Digitalna suspenzija ima stvarne psihološke posljedice koje se podcjenjuju. Post-Covid svijet promijenio je težinu online identiteta. Algoritamska moderacija bez jasnog konteksta stvara percepciju nepravde. DSA je pokušaj balansiranja moći, ali praksa će pokazati koliko su korisnici doista zaštićeni. Digitalni javni trg mora imati razinu transparentnosti proporcionalnu svojoj društvenoj moći.

<p style="font-size:0.85em; color:#6b7280; margin-top:28px; font-style:italic;">
Odricanje od odgovornosti: Ovaj sadržaj služi isključivo u informativne svrhe i predstavlja društvenu i analitičku refleksiju. Ne predstavlja pravni savjet.
</p>
