---
title: "Revolut napadači objavljuju podatke VIP korisnika"
slug: "revolut-napadaci-objavljuju-podatke-vip-korisnika"
date: 2026-09-14T06:00:00+02:00
category: "Cybersecurity"
translationKey: "revolut-attackers-leak-vip-customer-data-2026-09-14"
source: "Cointelegraph, Revolut, International Cyber Digest, ZachXBT, Reddit, Metaadvisor.eu"
source_url: ""
author: "Metaadvisor.eu"
image_url: "/images/hack/Revolut-attackers-leak-VIP-customer-data-compressed.jpg"
featured_image: "/images/hack/Revolut-attackers-leak-VIP-customer-data-compressed.jpg"
image: "/images/hack/Revolut-attackers-leak-VIP-customer-data-compressed.jpg"
thumbnail: "/images/hack/Revolut-attackers-leak-VIP-customer-data-compressed.jpg"
image_alt: "Napadači objavljuju podatke VIP korisnika Revoluta, uključujući identifikacijske dokumente i verifikacijske selfieje"
image_credit: "Metaadvisor.eu / AI"
tags: ["Revolut", "kibernetička sigurnost", "cybersecurity", "curenje podataka", "osobni podaci", "VIP korisnici", "krađa identiteta", "KYC", "selfie verifikacija", "Bitcoin", "kriptovalute", "Alexander Shevchenko", "Felix Römer", "Mark Karpelès", "Mt. Gox", "Gamdom", "ucjena", "privatnost"]
description: "Napadači koji su došli do podataka Revolutovih korisnika navodno su počeli objavljivati identifikacijske dokumente i selfieje te prijete novim objavama dok Revolut ne plati."
summary: "Revolutov incident prerastao je u aktivnu ucjenu. Napadači navodno objavljuju podatke korisnika i prijete svakodnevnim novim leakovima. Među javno imenovanim osobama nalaze se Alexander Shevchenko i Felix Römer, dok je bivši CEO Mt. Goxa Mark Karpelès ranije potvrdio da je i sam pogođen incidentom."
---

*Slika je simbolična.*

# Revolut napadači objavljuju podatke VIP korisnika: Shevchenko, Römer i Karpelès među imenima
...
<div style="text-align:center; margin:2rem auto;">
  <a href="https://metaadvisor.eu/hr/news/revolut-izlozio-podatke-korisnika-nakon-laznog-zahtjeva-drzavne-agencije/" target="_blank" rel="noopener">
    <img src="/images/hack/Revolut-sent-user-data-to-scammers.jpg" alt="Revolut izložio podatke korisnika nakon lažnog zahtjeva državne agencije" style="display:block; width:70%; max-width:700px; height:auto; margin:0 auto;">
  </a>
  <p style="font-size:0.9em; margin-top:0.6rem;"><a href="https://metaadvisor.eu/hr/news/revolut-izlozio-podatke-korisnika-nakon-laznog-zahtjeva-drzavne-agencije/" target="_blank" rel="noopener"><strong>Revolut izložio podatke korisnika nakon lažnog zahtjeva državne agencije</strong></a></p>
</div>
...
## Objavljeni selfieji otvaraju još jedno neugodno pitanje

Posebno zabrinjava objavljivanje selfieja korištenih za verifikaciju identiteta. Fotografija lica zajedno s osobnim dokumentom, adresom, brojem telefona i financijskim informacijama napadaču daje puno više od običnog popisa osobnih podataka.

Ali ovaj incident otvara i šire pitanje: koliko selfieja i snimki lica ostavljamo po različitim aplikacijama i online platformama?

Već smo pisali o tome da Meta u određenim postupcima verifikacije od korisnika traži selfie ili video snimku lica. U nekim slučajevima korisnik takvu snimku preda, a račun nakon toga svejedno bude ugašen. Što se zatim događa s tim snimkama, koliko dugo se čuvaju i za što se koriste?

<div style="text-align:center; margin:2rem auto;">
  <a href="https://metaadvisor.eu/hr/news/sto-meta-facebook-instagram-radi-sa-snimkom-vaseg-lica/" target="_blank" rel="noopener">
    <img src="/images/Meta/Meta-face-recording.png" alt="Što Meta radi sa snimkom vašeg lica?" style="display:block; width:70%; max-width:700px; height:auto; margin:0 auto;">
  </a>
  <p style="font-size:0.9em; margin-top:0.6rem;"><a href="https://metaadvisor.eu/hr/news/sto-meta-facebook-instagram-radi-sa-snimkom-vaseg-lica/" target="_blank" rel="noopener"><strong>Što Meta radi sa snimkom vašeg lica?</strong></a></p>
</div>

Revolutov slučaj sada pokazuje zašto to nije samo teoretsko pitanje privatnosti. Svaka platforma koja godinama čuva takve podatke istodobno čuva materijal koji u slučaju kompromitacije može završiti izvan njezinih sustava.

## Rizik više nije samo teorijski
...
## Priča se u samo nekoliko dana potpuno promijenila
...
* **Revolutov incident prerastao je iz curenja podataka u aktivan pokušaj ucjene kompanije.**
* Među prvim javno imenovanim osobama čiji su dokumenti navodno objavljeni nalaze se profesionalni tenisač Alexander Shevchenko i Gamdom CEO Felix Römer.
* **Bivši CEO Mt. Goxa Mark Karpelès ranije je potvrdio da je i sam pogođen originalnim incidentom, ali zasad nema potvrde da su njegovi dokumenti javno objavljeni.**
* Napadači navodno prijete svakodnevnim novim objavama dok Revolut ne plati.
* **Tvrdnje s mađarskog Reddita da su korisnici možda birani prema Bitcoin adresama posebno su zanimljive, ali zasad nisu neovisno potvrđene.**
* Objavljivanje verification selfieja pokazuje koliko osjetljivi mogu biti podaci koje korisnici godinama ostavljaju financijskim i tehnološkim platformama.
* **Kombinacija osobnog dokumenta, fotografije lica, adrese i kompletne financijske povijesti može stvoriti izuzetno ozbiljan rizik za krađu identiteta i ciljane napade.**
* Revolut još nije objavio točan broj pogođenih korisnika, identitet kompromitirane državne agencije niti državu iz koje ona dolazi.
* **Najvažnije pitanje sada više nije samo kako je Revolut predao podatke, nego koliko podataka napadači imaju i koga će sljedećeg pokušati javno izložiti.**

**Pratite Metaadvisor.eu za više vijesti i analiza o kibernetičkoj sigurnosti, privatnosti, fintechu, kriptovalutama, online prijevarama i zaštiti osobnih podataka.**

**Disclaimer:** Ovaj članak služi isključivo u informativne svrhe i temelji se na javno dostupnim informacijama i izvještajima dostupnima 14. rujna 2026. Pojedine tvrdnje o objavljenim podacima, izboru meta, Telegram porukama i mogućem korištenju Bitcoin aktivnosti kao kriterija dolaze iz izvještaja medija i objava na društvenim mrežama te nisu sve neovisno potvrđene. Tekst ne predstavlja pravni, financijski, sigurnosni ili investicijski savjet.
