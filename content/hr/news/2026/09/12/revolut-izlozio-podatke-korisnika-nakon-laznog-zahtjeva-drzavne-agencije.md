---
title: "Revolut izložio podatke korisnika nakon lažnog zahtjeva državne agencije"
slug: "revolut-izlozio-podatke-korisnika-nakon-laznog-zahtjeva-drzavne-agencije"
...
image_alt: "Revolut predao osjetljive podatke korisnika nakon lažnog zahtjeva koji je stigao sa službene domene državne agencije"
image_credit: "Metaadvisor.eu / AI"
tags: ["Revolut", "kibernetička sigurnost", "cybersecurity", "curenje podataka", "osobni podaci", "privatnost", "krađa identiteta", "phishing", "socijalni inženjering", "fintech", "bankarstvo", "kriptovalute", "Bitcoin", "zaštita podataka", "online prijevare"]
description: "Revolut je potvrdio da je osjetljive podatke dijela korisnika predao neovlaštenoj trećoj strani nakon lažnih zahtjeva koji su stigli sa službene e-mail domene stvarne državne agencije."
summary: "Revolut nije hakiran na klasičan način. Tvrtka je sama predala osjetljive podatke ograničenog broja korisnika nakon što je povjerovala zahtjevima koji su izgledali kao legitimni zahtjevi državne agencije. Još nije poznato koja je agencija kompromitirana niti iz koje države dolazi."
---
...
**Disclaimer:** Ovaj članak služi isključivo u informativne svrhe i temelji se na javno dostupnim informacijama, izjavama Revoluta i medijskim izvještajima dostupnima 12. rujna 2026. Identitet državne agencije, država kojoj pripada, točan broj pogođenih korisnika i puni tehnički detalji incidenta u trenutku objave nisu javno potvrđeni. Tekst ne predstavlja pravni, financijski, sigurnosni ili investicijski savjet.
