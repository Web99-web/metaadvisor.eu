---
title: "Stablecoin News: Ripple Brings $700M RLUSD to Africa With Insurance Pilots for Climate Relief"
...
summary: "Stablecoins are gaining traction in cross-border payments, especially in emerging markets where access to reliable currencies and banks is limited."
tags: ["Ripple", "Stablecoin", "RLUSD", "Africa", "climate", "crypto"]
...
RLUSD, launched in late 2024 and issued by a New York trust company regulated by the state’s Department of Financial Services, has grown to over $700 million in supply on Ethereum (ETH) and the XRP Ledger (XRP), RWA.xyz data shows. The token could be used for treasury operations, remittances and as collateral for trading tokenized assets such as commodities or securities, Ripple said.
...
**Our take:**  
Ripple is trying to position RLUSD not just as a payment token, but also as a tool for *real-world impact*. If climate-linked insurance succeeds, RLUSD could become a benchmark for socially responsible crypto innovation.
