...
summary: "An ‘OG’ whale opened a ~3,600 BTC short (~$400M) on Hyperliquid with liquidation near $139.9k/BTC. Was this sheer luck, informational edge, or tactical risk management? We break down the scenarios."
---

## What happened
According to **CoinDesk** and **LookOnChain**, a veteran Bitcoin whale opened a short position of about **3,600 BTC** (≈ **$438M**) on **Hyperliquid**, as BTC briefly dipped below **$120k**. The liquidation threshold for this trade is around **$139,900 per BTC**.

This entity had previously:
- sold **~3,000 BTC on spot**, and  
- a month earlier rotated **35,991 BTC into ETH**.
...
*Illustrative image. This is not financial advice.*
